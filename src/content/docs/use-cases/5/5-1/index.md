...
## 요구사항
이 페이지의 요구사항은 **UC-REG-01**(옷 등록)과 **UC-RETRY-01**(등록 재시도)을 실현한다. 등록 재시도는 등록이 실패했을 때만 일어나는 선택적 행위라 옷 등록을 확장한다.
...
| NFR-REG-10 | 남용 방지 | 회원 한 명이 보내는 등록·재시도 요청의 빈도를 제한하여 악의적인 대량 요청을 막는다. 제한 기준은 운영 설정값으로 둔다. |
