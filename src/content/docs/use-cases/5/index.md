...
- 등록: 옷을 옷장에 등록한다(촬영·갤러리, 서버 비동기 처리). [의류 등록](/use-cases/5/5-1)
- 조회: 옷장의 옷 목록을 조회한다. [의류 목록 조회](/use-cases/5/5-4)
- 수정: 등록된 옷의 이미지나 속성을 수정한다. [의류 수정](/use-cases/5/5-2/)
- 삭제: 옷장에서 옷을 삭제한다. [의류 삭제](/use-cases/5/5-3)
